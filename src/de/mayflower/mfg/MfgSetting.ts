module de.christopherstock.driver
{
    ...
    *****************************************************************************/
    export class MfgSetting
    {
        ...
        public      static      PLAYER_SPEED_MOVE_X                         :number             = 2.0;
        /** The player's vertical movement speed in pixels per tick. */
        public      static      PLAYER_SPEED_MOVE_Y                         :number             = 4.0;

        /** The obstacle's moving speed for horizontal directions. */
        public      static      OBSTACLE_SPEED_MOVE_X                      :number             = 1.0;
        /** The obstacle's moving speed for vertical directions. */
        public      static      OBSTACLE_SPEED_MOVE_Y                      :number             = 1.5;
